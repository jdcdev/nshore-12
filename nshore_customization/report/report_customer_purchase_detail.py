    ...
    def _get_report_values(self, docids, data=None):
        ...
        sqlstr = """
            SELECT
                ...
                CAST(SUM(((pt.list_price - l.price_unit) / pt.list_price) * 100) As numeric(36,2)) AS total_discounts,
                SUM((l.price_unit - pt.net_cost) * l.quantity) AS total_gross_profit,
                CAST(SUM((((l.price_unit - pt.net_cost) * l.quantity) / l.price_unit) * 100) AS numeric(36,2)) as total_profit_margin,
